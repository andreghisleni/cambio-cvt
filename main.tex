...
\begin{document}
  ...
  \begin{frame}{Evolução Tecnológica}
      ...
      \begin{center}
        \includegraphics[width=0.4\textwidth]{images/daf_variomatic.png}
  ...
  \begin{frame}{Polias e Correia}
    \begin{columns}
      ...
      \centering
      \includegraphics[width=0.9\textwidth]{images/polias_cvt.jpg}
  ...
  \end{frame}
    ...
    \begin{frame}{Video Demonstrativo}

        \begin{block}{Demonstração Prática}
            O sistema utiliza uma \textbf{Launch Gear} para eliminar a inércia inicial, um dos maiores problemas dos CVTs convencionais.
        \end{block}
        
        \begin{itemize}
            \item \textbf{Vídeo Demonstrativo:} Funcionamento do conjunto de engrenagem de partida e transição para polias.
            \item \textbf{Link:} \href{https://www.youtube.com/shorts/F-I2-d2PEBk}{\textit{Clique aqui para abrir o video no YouTube}}.
        \end{itemize}
